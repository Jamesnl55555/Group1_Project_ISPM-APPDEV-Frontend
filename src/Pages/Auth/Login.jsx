        ...
        >
          ...
          <form onSubmit={submit}>
            ...
            <div style={{ marginBottom: '1rem' }}>
              <label htmlFor="email" style={{ fontWeight: 550, color: '#3b3b3b' }}>E-mail</label>
              <TextInput
                id="email"
                type="email"
                value={email}
            ...
            {/* Remember Me */}
            <div style={{ marginTop: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.6rem', color: 'gray', marginLeft: '1rem', marginRight: '1rem' }}>
